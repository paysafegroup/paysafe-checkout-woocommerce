...
abstract class WC_Gateway_Paysafe_Base extends WC_Payment_Gateway {
    ...
    const ALLOW_TOKENIZATION_SUPPORT = true;
    const ALLOW_APPLE_PAY_SUPPORT = true;
    const ALLOW_GOOGLE_PAY_SUPPORT = true;
    ...
    public function paysafe_woo_admin_head_scripts()
    {
	    ...
	    wp_register_style(
		    $admin_css_handle,
		    plugin_dir_url(dirname(__FILE__)) . '../assets/admin/admin-paysafe.css',
		    [],
		    PAYSAFE_WOO_VERSION
	    );
    ...
    public function is_save_token_enabled(string $payment_type = WC_Gateway_Paysafe::PAYMENT_TYPE_CODE): bool
    {
        ...
        return (
                $settings['save_tokens_' . $payment_type] ?? self::SAVE_TOKEN_DEFAULT_VALUE
            ) === 'yes';
    }
    ...
    public function is_cvv_token_enabled(string $payment_type = WC_Gateway_Paysafe::PAYMENT_TYPE_CODE): bool
    {
	    ...
	    return (
                $settings['cvv_tokens_' . $payment_type] ?? self::SAVE_TOKEN_DEFAULT_VALUE
            ) === 'yes';
    }
