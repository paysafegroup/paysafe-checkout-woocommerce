...
abstract class WC_Gateway_Paysafe_Base extends WC_Payment_Gateway {
    ...
    public function enqueue_paysafe_scripts()
    {
        ...
        wp_enqueue_script($this->id . '-hosted');
    ...
    public function payment_fields() {
        ...
        if ( $description ) {
            // KSES is run within get_description, but not here since there may be custom HTML returned by extensions.
