...
class PaysafeApiCardConnector extends PaysafeApiBaseConnector
{
	 ...
	 * @throws PaysafeApiException
	 */
	public function getPaysafePaymentHandleData(string $merchantRefNum): PaysafeApiResult
	{
		$this->logApiDebug(
			"Card Connector: get payment handle data for merchant ref number: "
			. substr($merchantRefNum, 5, 3)
			. '...'
		);
