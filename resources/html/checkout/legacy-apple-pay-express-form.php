...
<fieldset style="text-align: center; font-family: Manrope, sans-serif;">
	...
	<span style="font-size: 1.2em"><?php echo $is_google_pay_enabled ? esc_html(__('Easy and secure payments with Paysafe', 'paysafe-checkout')) : esc_html($this->description); ?></span>
	<hr />
