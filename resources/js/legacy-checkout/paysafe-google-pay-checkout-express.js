(function( $ ) {
    ...
    const init_express_google_pay_on_checkout_page = function() {
        ...
        if (google_pay_paysafe_config.google_pay_issuer_country) {
            paysafeOptions.fields.googlePay.country = google_pay_paysafe_config.google_pay_issuer_country;
        }
        if (google_pay_paysafe_config.google_pay_merchant_id) {
            paysafeOptions.fields.googlePay.merchantId = google_pay_paysafe_config.google_pay_merchant_id;
        }
                ...
                if (paymentMethods.googlePay && !paymentMethods.googlePay.error) {
                    document.getElementById('paysafe-google-pay-express-button').addEventListener(
                        ...
                        function (event) {
                            ...
                            if (google_pay_paysafe_config.google_pay_issuer_country) {
                                hostedTokenizationOptions.googlePay.country = google_pay_paysafe_config.google_pay_issuer_country;
                            }
