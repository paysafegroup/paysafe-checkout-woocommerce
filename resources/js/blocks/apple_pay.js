                    ...
                    function (event) {
                        ...
                        hostedApplePayInstance
                            ...
                            .then(result => {
                                ...
                                if (currentCartData.billingAddress.first_name) {
                                    express_checkout_payload.billing = currentCartData.billingAddress;
                                } else {
                                    if (currentCartData.billingAddress.email) {
                                        express_checkout_payload.billing = {
