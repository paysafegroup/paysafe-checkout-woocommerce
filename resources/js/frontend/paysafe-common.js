...
export function show_paysafe_checkout_error(error_message) {
        ...
        paysafe.checkout.setup(
            ...
            function (instance, error, result) {
                if (result && result.paymentHandleToken) {
                    ...
                    if (instance) {
                        log_paysafe_error(log_error_endpoint, __("Payment failed. Popup was closed without a correct end message!", "paysafe-checkout") + ' ' + errorMessage, {'pace': 3});
