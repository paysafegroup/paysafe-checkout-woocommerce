...
function stableHash(obj) {
    try {
        ...
        try {
            ...
            return `unstringifiable:${name}:${msg}`;
        } catch {
                        ...
                        <div key={groupKey} className="paysafe-section">
                            ...
                            <Card className="paysafe-section__card">
                                ...
                                {groupKey === 'payment_methods' ? (
                                    <div className="paysafe-pm">
                                        ...
                                        {groupFields
                                            ...
                                            .map((methodField) => {
                                                ...
                                                const hasWarning = methodField.warning ? methodField.warning : false;
                                    ...
                                    <Notice status="warning" isDismissible={false}>
                                        <div> {renderWithBr(subscriptionNotice)} </div>
                                    </Notice>
                                ) : (
                                            ...
                                            <div key={field.key} className="paysafe-field-wrap">
                                                ...
                                                {field.type !== 'checkbox' && field.description && (
                                                    <div className="components-base-control__help">
                                                        {renderWithBr(field.description)}
                                                    </div>
                                                )}
                                            </div>
                                        ))
                                    ...
                                    {isWebhookField ? (
                                        <>
                                            ...
                                            {fieldByKey['webhook_title']?.description && (
                                                <div className="paysafe-webhook-title">
                                                    {renderWithBr(fieldByKey['webhook_title'].description)}
                                                </div>
                                            )}

                                            <strong className="paysafe-webhook-label">{ __('Webhook URL', 'paysafe-checkout') }</strong>
                                            <div className="paysafe-webhook-url">
                                                {renderWithBr(descHtml)}
                                            </div>
                ...
                >
                    <div className="configure-keys-fields">
                        ...
                        {pubKeyField?.description && (
                            <div className="components-base-control__help">
                                {renderWithBr(pubKeyField.description)}
                            </div>
                        )}
                        ...
                        <div className="paysafe-private-key">
                            ...
                            {privKeyField?.description && (
                                <div className="components-base-control__help">
                                    {renderWithBr(privKeyField.description)}
                                </div>
                            )}
                        </div>
