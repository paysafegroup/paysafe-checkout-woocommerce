...
const init_google_pay_hosted_integration = function () {
  ...
  const paysafeOptions = {
    ...
    fields: {
      googlePay: {
        ...
        type: 'buy',
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Pay with GooglePay', 'paysafe-checkout'),
        color: 'white-outline'
      }
    }
  };
...
const Content = props => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useEffect)(() => {
    if (is_hosted_integration) {
      init_google_pay_hosted_integration();
    }
