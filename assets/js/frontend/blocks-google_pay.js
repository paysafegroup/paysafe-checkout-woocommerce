...
const init_google_pay_hosted_integration = function (onClick, onClose, onError) {
  ...
  const paysafeOptions = {
    ...
    fields: {
      googlePay: {
        ...
        merchantId: settings.express_merchant_ref_num,
        country: settings.google_pay_issuer_country
      }
    }
  };
  ...
  if (billing_country) {
    paysafeOptions.fields.googlePay.supportedCountries = [billing_country];
  }
