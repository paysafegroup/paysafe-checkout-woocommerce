...
(() => {
/*!********************************************!*\
  !*** ./resources/js/frontend/apple_pay.js ***!
  \********************************************/
...
const settingsGooglePay = (0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_4__.getSetting)('google_pay_data', {});
...
const init_apple_pay_hosted_integration = function (onClick, onClose, onError) {
  ...
  const paysafeOptions = {
    ...
    fields: {
      applePay: {
        ...
        type: 'buy',
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Pay with Apple Pay', 'paysafe-checkout'),
        color: 'black',
        buttonWidth: '240px',
        buttonHeight: '55px'
      }
  ...
  if (is_apple_pay_google_pay_combo_activated) {
    ...
    paysafeOptions.fields.googlePay = {
      ...
      type: 'buy',
      color: 'black',
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Google Pay', 'paysafe-checkout'),
  ...
  paysafe.fields.setup(settings.authorization, paysafeOptions).then(instance => {
    ...
    if (paymentMethods.applePay && !paymentMethods.applePay.error) {
      document.getElementById('paysafe-apple-pay').addEventListener('click', function (event) {
        ...
        hostedApplePayInstance.tokenize(hostedTokenizationOptions).then(result => {
          const paymentToken = result.token || null;
          if (!paymentToken) {
            // todo align this text to standards
            const error_message = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("ERROR: Express checkout couldn't tokenize the payment information", "paysafe-checkout");
    ...
    if (is_apple_pay_google_pay_combo_activated && paymentMethods.googlePay && !paymentMethods.googlePay.error) {
      ...
      'click', function (event) {
        ...
        // payment process started
        onClick();
        fetch(settingsGooglePay.express_checkout_endpoint, {
          method: 'POST',
          credentials: 'same-origin',
          headers: new Headers({
            'Content-Type': 'application/json'
          ...
          if (json.status === 'success') {
            ...
            hostedApplePayInstance.tokenize(hostedTokenizationOptions).then(result => {
              ...
              fetch(settingsGooglePay.register_url, {
                method: 'POST',
                credentials: 'same-origin',
                headers: new Headers({
                  'Content-Type': 'application/json'
    ...
    const unsubscribe = onCheckoutSuccess(response => {
      ...
      if (orderId && paymentAmount) {
        ...
        const checkout_options = {
          ...
          environment: settings.test_mode ? 'TEST' : 'LIVE',
          displayPaymentMethods: ['applePay'],
...
const ExpressLabel = () => {
  let express_label = (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: 'paysafe-gateway-title'
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, label), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
    className: 'paysafe-gateway-image',
    src: settings.icon,
  ...
  if (is_apple_pay_google_pay_combo_activated) {
    let comboLabel = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Paysafe Express Payment', 'paysafe-checkout');
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: 'paysafe-gateway-title'
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, comboLabel));
  }
...
const ExpressContent = props => {
  ...
  let descriptionForDisplay = [(0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_3__.decodeEntities)(settings.description || ''))];
  if (is_apple_pay_google_pay_combo_activated) {
    descriptionForDisplay = [(0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_3__.decodeEntities)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Easy and secure payments with Paysafe', 'paysafe-checkout')))];
  }
  if (settings.test_mode) {
    descriptionForDisplay.push((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("hr", null));
    descriptionForDisplay.push((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
if (!is_hosted_integration) {
  ...
  (0,_woocommerce_blocks_registry__WEBPACK_IMPORTED_MODULE_2__.registerPaymentMethod)(PaysafeApplePayPayments);
} else {
  const PaysafeApplePayExpressPayment = {
    ...
    canMakePayment: cartData => {
      currentCartData = cartData;
      if (cartData.billingAddress && cartData.billingAddress.email !== '' && cartData.billingAddress.first_name !== '' && cartData.billingAddress.last_name !== '' && cartData.billingAddress.address_1 !== '' && cartData.billingAddress.city !== '' && cartData.billingAddress.postcode !== '') {
        return true;
      }
  ...
  (0,_woocommerce_blocks_registry__WEBPACK_IMPORTED_MODULE_2__.registerExpressPaymentMethod)(PaysafeApplePayExpressPayment);
}
// }
})();
...
/******/ })()
;
//# sourceMappingURL=blocks-apple_pay.js.map