          ...
          if (result && result.paymentHandleToken) {
            ...
            fetch(settings.register_url, {
              ...
              if (json.status === 'success') {
                instance.showSuccessScreen((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Your goods are now purchased. Expect them to be delivered in next 5 business days." + ' ' + errorMessage, "paysafe-checkout"));
              } else {
