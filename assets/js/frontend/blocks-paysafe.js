...
const is_cvv_verification = !!settings.cvv_verification;
      ...
      if (orderId && paymentAmount) {
        ...
        if (is_hosted_integration) {
          ...
          hostedPaymentInstance.tokenize(tokenizationOptions).then(result => {
            ...
            log_paysafe_error(error_message, []);
            show_checkout_error(error_message);
            show_checkout_error((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('The payment process failed. Please reload the page and try again', 'paysafe-checkout'));
          });
        } else {
