...
(() => {
/*!***********************************************!*\
  !*** ./resources/js/frontend/vippreferred.js ***!
  \***********************************************/
...
const settings = (0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_4__.getSetting)('vippreferred_data', {});
...
const Content = props => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useEffect)(() => {
    const unsubscribe = onPaymentSetup(async () => {
      ...
      let isVipPreferredConsumerIdValid = vippreferredConsumerIdInput && vippreferredConsumerIdInput.value && vippreferredConsumerIdInput.value.length && vippreferredConsumerIdInput.value.length >= 2 && vippreferredConsumerIdInput.value.length <= 50;
      if (isVipPreferredConsumerIdValid) {
        return {
          type: emitResponse.responseTypes.SUCCESS
        };
      }
      log_paysafe_error((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("The payment process failed.  VIP Preferred Social Security Number must be provided!", "paysafe-checkout"), {});
      return {
        type: emitResponse.responseTypes.ERROR,
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("The payment process failed.  VIP Preferred Social Security Number must be provided!", "paysafe-checkout")
      };
    });
    return () => {
      unsubscribe();
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useEffect)(() => {
    const unsubscribe = onCheckoutSuccess(response => {
      ...
      let vippreferredConsumerIdInput = document.getElementById('vippreferred_consumeridInput');
      let vippreferredConsumerIdValue = vippreferredConsumerIdInput && vippreferredConsumerIdInput.value && vippreferredConsumerIdInput.value.length && vippreferredConsumerIdInput.value.length >= 2 && vippreferredConsumerIdInput.value.length <= 50 ? vippreferredConsumerIdInput.value : '';
  ...
  descriptionForDisplay.push((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    id: "vippreferred_consumerid_label",
    className: "paysafe-general-form-label",
    htmlFor: "vippreferred_consumeridInput"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('VIP Preferred Social Security Number', 'paysafe-checkout')), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    id: "vippreferred_consumerid",
    className: "paysafe-input-field"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "text",
    className: "paysafe-input-field-input",
    name: "vippreferred_consumerid_input",
    id: "vippreferred_consumeridInput",
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Your VIP Preferred Social Security Number', 'paysafe-checkout'),
    min: "2",
    minLength: "2",
    max: "50",
    maxLength: "50"
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    id: "vippreferred_consumerid_spacer",
    className: "paysafe-general-form-spacer"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Enter your Social Security Number', 'paysafe-checkout'))));
  return descriptionForDisplay;
};
const PaysafeVippreferredPayments = {
...
if (!is_hosted_integration) {
  (0,_woocommerce_blocks_registry__WEBPACK_IMPORTED_MODULE_2__.registerPaymentMethod)(PaysafeVippreferredPayments);
}
})();

/******/ })()
;
//# sourceMappingURL=blocks-vippreferred.js.map