...
(() => {
/*!*******************************************!*\
  !*** ./resources/js/frontend/neteller.js ***!
  \*******************************************/
...
const settings = (0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_4__.getSetting)('neteller_data', {});
    ...
    const unsubscribe = onCheckoutSuccess(response => {
      ...
      if (orderId && paymentAmount) {
        ...
        const checkout_options = {
          ...
          displayPaymentMethods: ['neteller'],
...
if (!is_hosted_integration) {
  (0,_woocommerce_blocks_registry__WEBPACK_IMPORTED_MODULE_2__.registerPaymentMethod)(PaysafeNetellerPayments);
}
})();

/******/ })()
;
//# sourceMappingURL=blocks-neteller.js.map