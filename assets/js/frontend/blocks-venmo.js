...
(() => {
/*!****************************************!*\
  !*** ./resources/js/frontend/venmo.js ***!
  \****************************************/
...
const settings = (0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_4__.getSetting)('venmo_data', {});
    ...
    const unsubscribe = onCheckoutSuccess(response => {
      ...
      if (orderId && paymentAmount) {
        ...
        const checkout_options = {
          ...
          displayPaymentMethods: ['venmo'],
          paymentMethodDetails: {
            venmo: {
              accountId: settings.account_id,
              consumerId: '' + settings.account_id
            }
          },
          threeDs: {
...
if (!is_hosted_integration) {
  (0,_woocommerce_blocks_registry__WEBPACK_IMPORTED_MODULE_2__.registerPaymentMethod)(PaysafeVenmoPayments);
}
})();

/******/ })()
;
//# sourceMappingURL=blocks-venmo.js.map