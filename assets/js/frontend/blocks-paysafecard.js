...
(() => {
/*!**********************************************!*\
  !*** ./resources/js/frontend/paysafecard.js ***!
  \**********************************************/
...
const settings = (0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_4__.getSetting)('paysafecard_data', {});
    ...
    const unsubscribe = onCheckoutSuccess(response => {
      ...
      if (orderId && paymentAmount) {
        ...
        const checkout_options = {
          ...
          displayPaymentMethods: ['paysafecard'],
...
if (!is_hosted_integration) {
  (0,_woocommerce_blocks_registry__WEBPACK_IMPORTED_MODULE_2__.registerPaymentMethod)(PaysafePaysafeCardPayments);
}
})();

/******/ })()
;
//# sourceMappingURL=blocks-paysafecard.js.map