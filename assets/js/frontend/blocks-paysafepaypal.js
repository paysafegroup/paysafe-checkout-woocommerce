...
(() => {
/*!************************************************!*\
  !*** ./resources/js/frontend/paysafepaypal.js ***!
  \************************************************/
...
const settings = (0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_4__.getSetting)('paysafepaypal_data', {});
...
const Content = props => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useEffect)(() => {
    const unsubscribe = onPaymentSetup(async () => {
      let paysafepaypalConsumerIdInput = document.getElementById('paysafepaypal_consumeridInput');
      let isPaysafePaypalConsumerIdValid = paysafepaypalConsumerIdInput && paysafepaypalConsumerIdInput.value && paysafepaypalConsumerIdInput.value.length;
      if (isPaysafePaypalConsumerIdValid) {
        return {
          type: emitResponse.responseTypes.SUCCESS
        };
      }
      log_paysafe_error((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("The payment process failed. You have to specify your Paypal email address!", "paysafe-checkout"), {});
      return {
        type: emitResponse.responseTypes.ERROR,
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("The payment process failed. You have to specify your Paypal email address!", "paysafe-checkout")
      };
    });
    return () => {
      unsubscribe();
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useEffect)(() => {
    const unsubscribe = onCheckoutSuccess(response => {
      ...
      let paysafepaypalConsumerIdInput = document.getElementById('paysafepaypal_consumeridInput');
      let paysafepaypalConsumerIdValue = paysafepaypalConsumerIdInput && paysafepaypalConsumerIdInput.value && paysafepaypalConsumerIdInput.value.length ? paysafepaypalConsumerIdInput.value : '';
  ...
  descriptionForDisplay.push((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    id: "paysafepaypal_consumerid_label",
    className: "paysafe-general-form-label",
    htmlFor: "paysafepaypal_consumeridInput"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Paypal email address', 'paysafe-checkout')), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    id: "paysafepaypal_consumerid",
    className: "paysafe-input-field"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "text",
    className: "paysafe-input-field-input",
    name: "paysafepaypal_consumerid_input",
    id: "paysafepaypal_consumeridInput",
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Your Paypal email address', 'paysafe-checkout'),
    min: "2",
    minLength: "2",
    max: "50",
    maxLength: "50"
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    id: "paysafepaypal_consumerid_spacer",
    className: "paysafe-general-form-spacer"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Enter the email from your Paypal account', 'paysafe-checkout'))));
...
if (!is_hosted_integration) {
  (0,_woocommerce_blocks_registry__WEBPACK_IMPORTED_MODULE_2__.registerPaymentMethod)(PaysafePaypalPayments);
}
})();

/******/ })()
;
//# sourceMappingURL=blocks-paysafepaypal.js.map