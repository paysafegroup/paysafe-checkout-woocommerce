...
const Content = props => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useEffect)(() => {
    const unsubscribe = onPaymentSetup(async () => {
      ...
      if (isPayByBankConsumerIdValid) {
        return {
          type: emitResponse.responseTypes.SUCCESS
        };
      }
      log_paysafe_error((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("The payment process failed. Pay By Bank consumer id must be set!", "paysafe-checkout"), {});
      return {
        type: emitResponse.responseTypes.ERROR,
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("The payment process failed. Pay By Bank consumer id must be set!", "paysafe-checkout")
      };
    });
    return () => {
      unsubscribe();
  ...
  descriptionForDisplay.push((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Pay By Bank consumer ID', 'paysafe-checkout')), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Your Pay By Bank consumer ID', 'paysafe-checkout'),
    min: "2",
    minLength: "2"
