...
(() => {
/*!**********************************************!*\
  !*** ./resources/js/frontend/pay_by_bank.js ***!
  \**********************************************/
...
const settings = (0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_4__.getSetting)('pay_by_bank_data', {});
...
const Content = props => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useEffect)(() => {
    const unsubscribe = onPaymentSetup(async () => {
      ...
      let isPayByBankConsumerIdValid = paybybankConsumerIdInput && paybybankConsumerIdInput.value && paybybankConsumerIdInput.value.length;
      let paybybankDOBInput = document.getElementById('paybybank_dobInput');
      let isPayByBankDOBValid = paybybankDOBInput && paybybankDOBInput.value && paybybankDOBInput.value.length;
      if (isPayByBankConsumerIdValid && isPayByBankDOBValid) {
        return {
          type: emitResponse.responseTypes.SUCCESS
        };
      }
      log_paysafe_error((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("The payment process failed. SSN and Date of Birth must be set!", "paysafe-checkout"), {});
      return {
        type: emitResponse.responseTypes.ERROR,
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("The payment process failed. SSN and Date of Birth must be set!", "paysafe-checkout")
      };
    });
    return () => {
      unsubscribe();
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useEffect)(() => {
    const unsubscribe = onCheckoutSuccess(response => {
      ...
      let paybybankConsumerIdInput = document.getElementById('paybybank_consumeridInput');
      let paybybankConsumerIdValue = paybybankConsumerIdInput && paybybankConsumerIdInput.value && paybybankConsumerIdInput.value.length ? paybybankConsumerIdInput.value : '';
      let paybybankDOBInput = document.getElementById('paybybank_dobInput');
      let paybybankDOBValue = paybybankDOBInput && paybybankDOBInput.value && paybybankDOBInput.value.length ? paybybankDOBInput.value : '';
      ...
      if (orderId && paymentAmount) {
        ...
        const checkout_options = {
          ...
          displayPaymentMethods: ['pay_by_bank'],
          paymentMethodDetails: {
            payByBank: {
              accountId: settings.account_id,
              consumerId: settings.consumer_id_encrypted
              // consumerId: paybybankConsumerIdValue,
            }
          },
          threeDs: {
        ...
        if (billing_phone) {
          checkout_options.customer.phone = billing_phone;
        }
  ...
  descriptionForDisplay.push((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    id: "paysafe-hosted-payment-form",
    className: "paysafe-hosted-payment-form"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
    id: "paybybank_consumerid_label",
    className: "paysafe-general-form-label",
    htmlFor: "paybybank_consumeridInput"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('SSN', 'paysafe-checkout')), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    id: "paybybank_consumerid",
    className: "paysafe-input-field"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "text",
    className: "paysafe-input-field-input",
    name: "paybybank_consumerid_input",
    id: "paybybank_consumeridInput",
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Your SSN', 'paysafe-checkout'),
    min: "2",
    minLength: "2"
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    id: "paybybank_consumerid_spacer",
    className: "paysafe-general-form-spacer"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Enter the consumer id from your Pay By Bank account', 'paysafe-checkout'))));
  descriptionForDisplay.push((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    id: "paysafe-hosted-payment-form2",
    className: "paysafe-hosted-payment-form"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
    id: "paybybank_dob_label",
    className: "paysafe-general-form-label",
    htmlFor: "paybybank_dobInput"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Date of birth', 'paysafe-checkout')), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    id: "paybybank_dob",
    className: "paysafe-input-field"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "date",
    className: "paysafe-input-field-input",
    name: "paybybank_dob_input",
    id: "paybybank_dobInput",
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Your Date of birth', 'paysafe-checkout'),
    min: "2",
    minLength: "2"
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    id: "paybybank_dob_spacer",
    className: "paysafe-general-form-spacer"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Enter your Date of Birth for your Pay By Bank account', 'paysafe-checkout'))));
  return descriptionForDisplay;
};
const PaysafePaybybankPayments = {
...
if (!is_hosted_integration) {
  (0,_woocommerce_blocks_registry__WEBPACK_IMPORTED_MODULE_2__.registerPaymentMethod)(PaysafePaybybankPayments);
}
})();

/******/ })()
;
//# sourceMappingURL=blocks-pay_by_bank.js.map