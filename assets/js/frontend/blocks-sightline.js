...
(() => {
/*!********************************************!*\
  !*** ./resources/js/frontend/sightline.js ***!
  \********************************************/
...
const settings = (0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_4__.getSetting)('sightline_data', {});
...
const Content = props => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useEffect)(() => {
    const unsubscribe = onPaymentSetup(async () => {
      ...
      let isSightlineConsumerIdValid = sightlineConsumerIdInput && sightlineConsumerIdInput.value && sightlineConsumerIdInput.value.length && sightlineConsumerIdInput.value.length >= 2 && sightlineConsumerIdInput.value.length <= 50;
      if (isSightlineConsumerIdValid) {
        return {
          type: emitResponse.responseTypes.SUCCESS
        };
      }
      log_paysafe_error((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("The payment process failed. Play+ (Sightline) consumer id must have between 2 and 50 characters!", "paysafe-checkout"), {});
      return {
        type: emitResponse.responseTypes.ERROR,
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("The payment process failed. Play+ (Sightline) consumer id must have between 2 and 50 characters!", "paysafe-checkout")
      };
    });
    return () => {
      unsubscribe();
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useEffect)(() => {
    const unsubscribe = onCheckoutSuccess(response => {
      ...
      let sightlineConsumerIdInput = document.getElementById('sightline_consumeridInput');
      let sightlineConsumerIdValue = sightlineConsumerIdInput && sightlineConsumerIdInput.value && sightlineConsumerIdInput.value.length && sightlineConsumerIdInput.value.length >= 2 && sightlineConsumerIdInput.value.length <= 50 ? sightlineConsumerIdInput.value : '';
      ...
      if (orderId && paymentAmount) {
        ...
        const checkout_options = {
          ...
          displayPaymentMethods: ['sightline'],
          paymentMethodDetails: {
            sightline: {
              accountId: settings.account_id,
              consumerId: '' + sightlineConsumerIdValue
              // consumerId: settings.consumer_id_encrypted_20,
              // ssn: '' + sightlineConsumerIdValue,
            }
          },
          threeDs: {
        ...
        checkout_options.shippingAddress = {
  ...
  descriptionForDisplay.push((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    id: "sightline_consumerid_label",
    className: "paysafe-general-form-label",
    htmlFor: "sightline_consumeridInput"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Play+ (Sightline) Loyalty Membership Number', 'paysafe-checkout')), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    id: "sightline_consumerid",
    className: "paysafe-input-field"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "text",
    className: "paysafe-input-field-input",
    name: "sightline_consumerid_input",
    id: "sightline_consumeridInput",
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Your Play+ (Sightline) Loyalty Membership Number', 'paysafe-checkout'),
    min: "2",
    minLength: "2",
    max: "50",
    maxLength: "50"
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    id: "sightline_consumerid_spacer",
    className: "paysafe-general-form-spacer"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Enter the Loyalty Membership Number from your Play+ (Sightline) account', 'paysafe-checkout'))));
  return descriptionForDisplay;
};
const PaysafeSightlinePayments = {
...
if (!is_hosted_integration) {
  (0,_woocommerce_blocks_registry__WEBPACK_IMPORTED_MODULE_2__.registerPaymentMethod)(PaysafeSightlinePayments);
}
})();

/******/ })()
;
//# sourceMappingURL=blocks-sightline.js.map